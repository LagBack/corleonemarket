...
const IC = {
  ...
  ranking:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9H4a3.5 3.5 0 0 1-.3-6.9C7 3.1 10 5.5 10.5 9v7"/><path d="M18 9h1.5a3.5 3.5 0 0 0 .3-6.9C17 3.1 14 5.5 13.5 9v7"/><line x1="4" y1="21" x2="20" y2="21"/></svg>`,
  ...
  pin:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 17v5"/><path d="M9 10.76A3.5 3.5 0 0 1 12 7.25V4a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v3.25A3.5 3.5 0 0 1 15 10.76"/><path d="M15 10.76V14"/><line x1="18" y1="10" x2="6" y2="22"/></svg>`,
  lock:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 9.9-1"/></svg>`,
  unlock:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M6 11V7a5 5 0 0 1 9.9-1"/></svg>`,
  // Other icons
